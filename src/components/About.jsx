          ...
          >
            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
              <p>
                ...
                <span className="text-white font-semibold">Udayana University</span>, Bali with a
                GPA of 3.77/4.00. I'm passionate about building modern, user-centered web
                applications that solve real problems.
              </p>
              <p>
                With hands-on experience in React.js, Node.js, and various databases, I enjoy
                turning complex challenges into simple, elegant solutions. I believe in clean code
